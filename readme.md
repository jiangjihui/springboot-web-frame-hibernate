# Web应用框架 - SpringBoot Hibernate  

当前版本:1.0.0  

## 项目简介  

使用Hibernate作为数据持久层，可自定义BaseDao基础类（基于较低版本Hibernate的jar包），同时也可使用jpa操作。
...
> https://blog.csdn.net/xiaonannew/article/details/82634241#commentsedit
